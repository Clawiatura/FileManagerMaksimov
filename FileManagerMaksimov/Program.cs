...
namespace FileManager_Chyornyy_POB2312
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.Write("'info', для отоброжения команд");
        ...
        public static void Logger(string command)
        {
            ...
            File.AppendAllText("C:\\Users\\maksi\\source\\repos\\FileManagerMaksimov\\FileManagerMaksimov\\logs.txt", $"[{current}]\n{command}\n\n");
        }
